/*
Some changes are present between this sql script
and the ER diagram, this was due to necessary changes required
from production.
Also the application itself may differ a tiny bit from this sql
as well
*/
